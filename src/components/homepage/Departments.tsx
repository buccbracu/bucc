...
export default function Departments() {
  ...
  return (
    <section className="bg-gray-100 px-4 py-12 text-center dark:bg-gray-900 dark:text-gray-100 md:px-20">
      ...
      <div className="mt-8 flex flex-col items-center space-y-6 md:flex-row md:items-start md:space-x-6 md:space-y-0 md:p-6 md:text-left">
        <div className="grid w-full flex-grow grid-flow-row gap-6 md:w-auto">
