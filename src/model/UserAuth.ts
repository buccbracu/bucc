...
const UserAuthSchema = new mongoose.Schema({
  ...
  userRoles: {
    ...
    default: userRoles[8], // Roles from here will be fetched in a particular order, so the first role will be the primary role. This eliminates the need for a sperate field for designations
  },
  name: {
    type: String,
    required: true,
